  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    const synth = new pipelines.ShellStep("Synth", {
      ...
      commands: [
        ...
        // Quality checks - secret scanning
        ...
        "npm ci",
        "npm run build",
        // Context params required for self-mutation to work correctly
    ...
    new FrontendStack(deployStage, "LandingPageFrontend-prod", {
      stackName: "LandingPageFrontend-prod",
      environment: "prod",
